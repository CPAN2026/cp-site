...
export default function CTAWhatsApp() {
  return (
    <section className="py-12 md:py-20 bg-[#1a3a16]">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
          Pronto para cuidar do seu familiar?
        </h2>
        ...
        <a
          ...
          style={{ background: '#4a8c3f', boxSizing: 'border-box' }}
        ...
        >
          ...
          <span className="hidden sm:inline">Falar pelo WhatsApp agora</span>
        </a>
      </div>
    </section>
  )
